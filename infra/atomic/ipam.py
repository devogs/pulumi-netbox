...
def _create_single_asn(asn_data: Dict[str, Any], rir_resources: Dict[str, netbox.Rir]) -> netbox.Asn:
...
def _create_single_aggregate(agg_data: Dict[str, Any], rir_resources: Dict[str, netbox.Rir]) -> netbox.Aggregate:
...
def _create_single_prefix(prefix_data: Dict[str, Any], vrf_resources: Dict[str, netbox.Vrf]) -> netbox.Prefix:
