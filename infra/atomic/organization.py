...
def _create_single_tenant(
        tenant_data: Dict[str, Any],
        created_groups_resources: Dict[str, netbox.TenantGroup]
        ) -> netbox.Tenant:
...
def _create_single_site(
    ...
    group_id_input = site_group_resource.id.apply(
        lambda id: int(id)
        ) if site_group_resource else None
