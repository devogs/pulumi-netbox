...
def get_racks(filters: Optional[Sequence[Union['GetRacksFilterArgs', 'GetRacksFilterArgsDict']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:index/getRacks:getRacks', __args__, opts=opts, typ=GetRacksResult, package_ref=_utilities.get_package()).value
...
def get_racks_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetRacksFilterArgs', 'GetRacksFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:index/getRacks:getRacks', __args__, opts=opts, typ=GetRacksResult, package_ref=_utilities.get_package())
