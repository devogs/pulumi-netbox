...
def get_tenants(filters: Optional[Sequence[Union['GetTenantsFilterArgs', 'GetTenantsFilterArgsDict']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:index/getTenants:getTenants', __args__, opts=opts, typ=GetTenantsResult, package_ref=_utilities.get_package()).value
...
def get_tenants_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetTenantsFilterArgs', 'GetTenantsFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:index/getTenants:getTenants', __args__, opts=opts, typ=GetTenantsResult, package_ref=_utilities.get_package())
