...
def get_tenant_group(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:index/getTenantGroup:getTenantGroup', __args__, opts=opts, typ=GetTenantGroupResult, package_ref=_utilities.get_package()).value
...
def get_tenant_group_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:index/getTenantGroup:getTenantGroup', __args__, opts=opts, typ=GetTenantGroupResult, package_ref=_utilities.get_package())
