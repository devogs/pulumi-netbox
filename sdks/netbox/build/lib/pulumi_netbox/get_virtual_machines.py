...
def get_virtual_machines(filters: Optional[Sequence[Union['GetVirtualMachinesFilterArgs', 'GetVirtualMachinesFilterArgsDict']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:index/getVirtualMachines:getVirtualMachines', __args__, opts=opts, typ=GetVirtualMachinesResult, package_ref=_utilities.get_package()).value
...
def get_virtual_machines_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetVirtualMachinesFilterArgs', 'GetVirtualMachinesFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:index/getVirtualMachines:getVirtualMachines', __args__, opts=opts, typ=GetVirtualMachinesResult, package_ref=_utilities.get_package())
