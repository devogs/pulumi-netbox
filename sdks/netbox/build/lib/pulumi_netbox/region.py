...
class RegionArgs:
    def __init__(__self__, *,
                 ...
                 parent_region_id: Optional[pulumi.Input[_builtins.float]] = None,
    ...
    def parent_region_id(self) -> Optional[pulumi.Input[_builtins.float]]:
        return pulumi.get(self, "parent_region_id")

    @parent_region_id.setter
    def parent_region_id(self, value: Optional[pulumi.Input[_builtins.float]]):
...
@pulumi.type_token("netbox:index/region:Region")
class Region(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="parentRegionId")
    def parent_region_id(self) -> pulumi.Output[Optional[_builtins.float]]:
        return pulumi.get(self, "parent_region_id")
