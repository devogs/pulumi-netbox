...
class PrefixArgs:
    ...
    def prefix_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "prefix_id")

    @prefix_id.setter
    def prefix_id(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("netbox:index/prefix:Prefix")
class Prefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Prefix resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[_builtins.float]] = None,
            vlan_id: Optional[pulumi.Input[_builtins.float]] = None,
            vrf_id: Optional[pulumi.Input[_builtins.float]] = None) -> 'Prefix':
        """
