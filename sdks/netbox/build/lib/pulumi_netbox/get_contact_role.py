...
def get_contact_role(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:index/getContactRole:getContactRole', __args__, opts=opts, typ=GetContactRoleResult, package_ref=_utilities.get_package()).value

    return AwaitableGetContactRoleResult(
        id=pulumi.get(__ret__, 'id'),
        name=pulumi.get(__ret__, 'name'),
        slug=pulumi.get(__ret__, 'slug'))
def get_contact_role_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:index/getContactRole:getContactRole', __args__, opts=opts, typ=GetContactRoleResult, package_ref=_utilities.get_package())
