...
def get_device_interfaces(filters: Optional[Sequence[Union['GetDeviceInterfacesFilterArgs', 'GetDeviceInterfacesFilterArgsDict']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:index/getDeviceInterfaces:getDeviceInterfaces', __args__, opts=opts, typ=GetDeviceInterfacesResult, package_ref=_utilities.get_package()).value
...
def get_device_interfaces_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetDeviceInterfacesFilterArgs', 'GetDeviceInterfacesFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:index/getDeviceInterfaces:getDeviceInterfaces', __args__, opts=opts, typ=GetDeviceInterfacesResult, package_ref=_utilities.get_package())
