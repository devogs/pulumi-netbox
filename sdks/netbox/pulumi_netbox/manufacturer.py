...
class ManufacturerArgs:
    def __init__(__self__, *,
                 manufacturer_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def manufacturer_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "manufacturer_id")

    @manufacturer_id.setter
    def manufacturer_id(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("netbox:index/manufacturer:Manufacturer")
class Manufacturer(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="manufacturerId")
    def manufacturer_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "manufacturer_id")
