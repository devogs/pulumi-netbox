...
def get_rack_role(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:index/getRackRole:getRackRole', __args__, opts=opts, typ=GetRackRoleResult, package_ref=_utilities.get_package()).value
...
def get_rack_role_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:index/getRackRole:getRackRole', __args__, opts=opts, typ=GetRackRoleResult, package_ref=_utilities.get_package())
