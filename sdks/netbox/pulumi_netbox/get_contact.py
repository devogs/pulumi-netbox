...
def get_contact(description: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('netbox:index/getContact:getContact', __args__, opts=opts, typ=GetContactResult, package_ref=_utilities.get_package()).value
...
def get_contact_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('netbox:index/getContact:getContact', __args__, opts=opts, typ=GetContactResult, package_ref=_utilities.get_package())
