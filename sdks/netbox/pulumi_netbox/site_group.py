...
class SiteGroupArgs:
    def __init__(__self__, *,
                 ...
                 site_group_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def site_group_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "site_group_id")

    @site_group_id.setter
    def site_group_id(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("netbox:index/siteGroup:SiteGroup")
class SiteGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SiteGroup resource with the given unique name, props, and options.
    ...
    @_builtins.property
    @pulumi.getter(name="siteGroupId")
    def site_group_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "site_group_id")
