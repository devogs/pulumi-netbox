...
class RirArgs:
    def __init__(__self__, *,
                 ...
                 rir_id: Optional[pulumi.Input[_builtins.str]] = None,
                 slug: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a Rir resource.
        :param pulumi.Input[_builtins.bool] is_private: Defaults to <span pulumi-lang-nodejs="`false`" pulumi-lang-dotnet="`False`" pulumi-lang-go="`false`" pulumi-lang-python="`false`" pulumi-lang-yaml="`false`" pulumi-lang-java="`false`">`false`</span>.
        """
    ...
    def rir_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        return pulumi.get(self, "rir_id")

    @rir_id.setter
    def rir_id(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("netbox:index/rir:Rir")
class Rir(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="rirId")
    def rir_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "rir_id")
